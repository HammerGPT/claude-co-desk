...
const TEXTS = {
    ...
    en: {
        ...
        // 执行模式相关
        'executionMode.title': 'Execution Mode',
        'executionMode.interactive': 'Interactive Mode',
        'executionMode.background': 'Background Mode',
        'executionMode.interactive.desc': 'Real-time display, supports interruption, keep page open',
        'executionMode.background.desc': 'Background execution, can close page, view results when complete',
        'executionMode.scheduled.notice': 'Scheduled tasks will automatically use background mode',
        'executionMode.background.tips': 'For completion notifications, add to task description: "Send WeChat notification when complete"',

        // 任务状态相关
        'task.status.running': 'Running...',
        'task.status.completed': 'Completed',
        'task.status.failed': 'Failed',
        'task.action.viewResult': 'View Result',
        'task.action.openSession': 'Open Session',
        'task.result.title': 'View Result',
    ...
    zh: {
        ...
        // 执行模式相关
        'executionMode.title': '执行方式',
        'executionMode.interactive': '交互模式',
        'executionMode.background': '后台模式',
        'executionMode.interactive.desc': '实时显示执行过程，支持中断，需保持页面打开',
        'executionMode.background.desc': '后台执行，可关闭页面，完成后查看结果',
        'executionMode.scheduled.notice': '定时任务将自动使用后台模式执行',
        'executionMode.background.tips': '如需获取完成通知，请在任务描述中添加："完成后发送微信通知"',

        // 任务状态相关
        'task.status.running': '运行中...',
        'task.status.completed': '已完成',
        'task.status.failed': '执行失败',
        'task.action.viewResult': '查看结果',
        'task.action.openSession': '打开会话',
        'task.result.title': '查看结果',
