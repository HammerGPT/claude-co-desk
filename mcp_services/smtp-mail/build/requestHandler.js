...
import { getSmtpConfigs, saveSmtpConfigs, getEmailTemplates, saveEmailTemplate, deleteEmailTemplate, getEmailLogs } from "./config.js";
 ...
 */
export async function setupRequestHandlers(server, tools) {
    // Handle tool listing
 ...
 */
async function handleSendBulkEmails(parameters) {
    try {
 ...
 */
async function handleAddSmtpConfig(parameters) {
    try {
 ...
 */
async function handleUpdateSmtpConfig(parameters) {
    try {
        // Get existing configs
        const configs = await getSmtpConfigs();
        ...
        if (parameters.name !== undefined)
            updatedConfig.name = parameters.name;
        if (parameters.host !== undefined)
            updatedConfig.host = parameters.host;
        if (parameters.port !== undefined)
            updatedConfig.port = parameters.port;
        if (parameters.secure !== undefined)
            updatedConfig.secure = parameters.secure;
        if (parameters.user !== undefined)
            updatedConfig.auth.user = parameters.user;
        if (parameters.pass !== undefined)
            updatedConfig.auth.pass = parameters.pass;
        // Handle default flag
 ...
 */
async function handleDeleteSmtpConfig(parameters) {
    try {
        // Get existing configs
        const configs = await getSmtpConfigs();
 ...
 */
async function handleAddEmailTemplate(parameters) {
    try {
 ...
 */
async function handleUpdateEmailTemplate(parameters) {
    try {
        // Get existing templates
        const templates = await getEmailTemplates();
        ...
        if (parameters.name !== undefined)
            updatedTemplate.name = parameters.name;
        if (parameters.subject !== undefined)
            updatedTemplate.subject = parameters.subject;
        if (parameters.body !== undefined)
            updatedTemplate.body = parameters.body;
        // Handle default flag
 ...
 */
async function handleDeleteEmailTemplate(parameters) {
    try {
        // Get existing templates
        const templates = await getEmailTemplates();
