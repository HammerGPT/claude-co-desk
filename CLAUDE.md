...
Claude Co-Desk 是基于Claude Code构建的本地智能任务自动化系统，探索AI Agent完全掌控系统资源能达到的自动化的极限。项目利用Claude Code完整的上下文工程框架，构建多智能体协作平台，实现企业级任务自动化解决方案，采用Python + FastAPI后端和原生前端技术栈。
...
### 核心产品定位
**AI Agent完全掌控系统资源的智能任务自动化系统**
- 基于Claude Code完整上下文工程框架的多智能体协作平台
- 核心价值：探索AI Agent在系统级资源控制下能达到的自动化极限
...
2. **智能体管理思维**
   - 用户角色：系统管理者/任务协调者
   - AI角色：任务调度器（负责智能体调度分工）
   - 数字智能体：具备专业技能的自主执行单元
   - 成本透明：token消耗即计算成本
   - **智能体学习能力**：能够根据任务需求自主学习新技能(获取新工具)
...
- 提供超越传统RPA的智能化解决方案
- 本地部署确保数据安全和隐私保护
- **独特价值**：AI Agent具备无限工具扩展能力，实现真正的系统级自动化
...
### 技术演进路径
1. **第一阶段**：完善智能文件管理系统
2. **第二阶段**：开发多智能体协作机制 + MCP工具管理器
3. **第三阶段**：构建完整的任务管理器 + 工具开发引擎
4. **第四阶段**：企业级功能和商业化

### 核心价值主张
**"探索AI Agent完全掌控系统资源能达到的自动化的极限，构建基于Claude Code的企业级智能任务自动化解决方案，实现真正的系统级AI自动化"**

### 关键技术优势
- **近100%任务完成率**：基于MCP协议的强大工具集成能力
- **自主技能扩展**：智能体能识别需求并自动获取所需工具
- **真正的AI自动化**：从被动工具使用转向主动问题解决
- **系统级资源控制**：AI Agent可完全掌控系统资源实现深度自动化
...
- `employees_manager.js` - 数字智能体团队管理器
